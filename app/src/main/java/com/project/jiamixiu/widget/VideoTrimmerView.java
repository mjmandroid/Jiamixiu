...
import com.project.jiamixiu.interfaces.IVideoTrimmerView;
...
import static com.project.jiamixiu.utils.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
  ...
  private String[] mTitles = {"急慢", "慢","正常","快","很快"};
  ...
  private void init(Context context) {
    ...
    segmentTabLayout = findViewById(R.id.tl_speed);
  ...
  private void setUpListeners() {
    ...
    segmentTabLayout.setOnTabSelectListener(new OnTabSelectListener() {
      ...
      public void onTabSelect(int position) {
        mOnTrimVideoListener.onSpeedSelect(position);
      }
  ...
  public void onSaveClicked() {
    if (mRightProgressPos - mLeftProgressPos < VideoTrimmerUtil.MIN_SHOOT_DURATION) {
      ...
      VideoTrimmerUtil.trim(mContext, mSourceUri.getPath(), getTrimmedVideoPath(), mLeftProgressPos, mRightProgressPos, mOnTrimVideoListener,isChange,currentTab);
    }
  }
  ...
  private String getTrimmedVideoPath() {
    if (mFinalPath == null) {
      ...
      if (file != null) mFinalPath = file.getAbsolutePath()+File.separator+"MyVideo";
    }
    return mFinalPath;
  }
