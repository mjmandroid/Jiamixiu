package com.reafor.jiamixiu.function.emoji.adapter;
...
import com.reafor.jiamixiu.function.emoji.util.ScreenUtils;
...
public class HorizontalRecyclerviewAdapter extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(model.isSelected){
            holder.imageBtn.setBackgroundColor(Color.parseColor("#f5f5f5"));
        }else {
            holder.imageBtn.setBackgroundColor(Color.parseColor("#ffffff"));
        }
