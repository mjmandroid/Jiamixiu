...
//                Logger.e(field.getName() + " : " + field.get(null));
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        File infoDir = new File(rootPath, "infos");
        if (!infoDir.exists()){
            infoDir.mkdirs();
        }
        try {
            PrintWriter pt = new PrintWriter(new FileOutputStream(infoDir.getAbsoluteFile()+File.separator+System.currentTimeMillis()+".txt"));
            pt.write(crashInfo);
            pt.flush();
